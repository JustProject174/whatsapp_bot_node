...
По любым вопросам можно писать сюда или звонить по номеру:
📱 +7 (XXX) XXX-XX-XX
...
📍 Точное местоположение и координаты пришлём по запросу.
...
1. Тип номера (КОМФОРТ или ЭКОНОМ)
2. Номер дома/комнаты
3. Даты заезда и выезда  
4. Количество гостей
5. Контактный телефон

Пример: "Дом №8 КОМФОРТ, 15-17 июля, 4 человека, +7-999-123-45-67"

Или позвоните по телефону: +7 (XXX) XXX-XX-XX
